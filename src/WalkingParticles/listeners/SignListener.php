		...
		if($event->getBlock()->getID() == 323 || $event->getBlock()->getID() == 63 || $event->getBlock()->getID() == 68){
			...
			if($sign[0] == '§f[§aWParticles§f]' || $sign[0] == '§f[§aWalkp§f]'){
				if($event->getPlayer()->hasPermission("walkingparticles.sign.destroy")){
					$event->getPlayer()->sendMessage($this->getPlugin()->colorMessage("&bWalkingParticles &esign has been destroyed!"));
					return true;
				} else{
				...
				if($event->getPlayer()->hasPermission("walkingparticles.sign.create")){
					if(! empty($sign[1]) && ! empty($sign[2])){
						...
						if(in_array($sign[1], $allowed)){
							...
							endswitch
							;
							$event->getPlayer()->sendMessage($this->getPlugin()->colorMessage("&bWalkingParticles &asign created!"));
				...
				if(empty($sign[1]) !== true && empty($sign[2]) !== true){
					if($event->getPlayer()->hasPermission("walkingparticles.sign.toggle")){
						switch(strtolower($sign[1])):
							case "§eadd":
								...
								$event->getPlayer()->sendMessage($this->getPlugin()->colorMessage("&aYou added your &bWalkingParticles&a's " . $particle . " particle!"));
							...
							case "§eremove":
								...
								$event->getPlayer()->sendMessage($this->getPlugin()->colorMessage("&aYou removed your &bWalkingParticles&a's " . $particle . " particle!"));
								$event->getPlayer()->getLevel()->addSound(new BatSound($event->getPlayer()), $this->getPlugin()->getServer()->getOnlinePlayers());
								return true;
							break;
							case "§eset":
								...
								$event->getPlayer()->sendMessage($this->getPlugin()->colorMessage("&aYou set your &bWalkingParticles&a's particle to &e" . $particle . "!"));
								$event->getPlayer()->getLevel()->addSound(new BatSound($event->getPlayer()), $this->getPlugin()->getServer()->getOnlinePlayers());
								return true;
							break;
							case "§eamplifier":
								...
								$event->getPlayer()->sendMessage($this->getPlugin()->colorMessage("&aYou changed your &bWalkingParticles&a's amplifier!"));
								$event->getPlayer()->getLevel()->addSound(new BatSound($event->getPlayer()), $this->getPlugin()->getServer()->getOnlinePlayers());
								return true;
							break;
							case "§edisplay":
					...
					if($event->getPlayer()->hasPermission("walkingparticles.sign.toggle")){
						switch(strtolower($sign[1])):
							...
							break;
							case "§eget":
								$event->getPlayer()->sendMessage($this->getPlugin()->colorMessage("&aYour &bWalkingParticles&a: &f" . $this->getPlugin()->getAllPlayerParticles($event->getPlayer())));
								$event->getPlayer()->getLevel()->addSound(new ClickSound($event->getPlayer()), $this->getPlugin()->getServer()->getOnlinePlayers());
								return true;
							break;
							case "§eclear":
								...
								$event->getPlayer()->sendMessage($this->getPlugin()->colorMessage("&aYour &bWalkingParticles &ahas been cleared!"));
								$event->getPlayer()->getLevel()->addSound(new BatSound($event->getPlayer()), $this->getPlugin()->getServer()->getOnlinePlayers());
								return true;
							break;
							case "§elist":
							...
							case "§eon":
								...
								$event->getPlayer()->sendMessage($this->getPlugin()->colorMessage("&aYour WalkingParticles has been turned on!"));
								$event->getPlayer()->getLevel()->addSound(new ClickSound($event->getPlayer()), $this->getPlugin()->getServer()->getOnlinePlayers());
								return true;
							break;
							case "§eoff":
								...
								$event->getPlayer()->sendMessage($this->getPlugin()->colorMessage("&aYour WalkingParticles has been turned off!"));
								$event->getPlayer()->getLevel()->addSound(new ClickSound($event->getPlayer()), $this->getPlugin()->getServer()->getOnlinePlayers());
								return true;
							break;
						endswitch
					...
					$event->getPlayer()->sendMessage($this->getPlugin()->colorMessage("&cSorry, you're clicking an incorrect &bWalkingParticles &csign!"));
					return false;
				}
			}
		}
